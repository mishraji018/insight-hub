      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-card p-8 shadow-2xl border-primary/20 animate-in zoom-in-95 duration-500 relative overflow-hidden">
          ...
          <div className="mt-8 flex justify-center">
            <button onClick={() => navigate.push('/login')} className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest hover:text-primary transition-colors flex items-center gap-1">
